...
public class NineByNine extends Block{
	...
	public NineByNine(int ID, Material Material) {
		...
		this.setUnlocalizedName(dman.library.Reasource.BlockNineByNineULName);
	}
	
	@SideOnly(Side.CLIENT)
	public void registerIcons(IconRegister icon){
		this.blockIcon = icon.registerIcon(Reasource.Mod_ID + ":" + dman.library.Reasource.ChargeTopBottom);
		this.iconFront = icon.registerIcon(Reasource.Mod_ID + ":" + dman.library.Reasource.BlockNineByNineTextName);
	...
	public int idDropped(int par1, Random random, int par3){
		return dman.library.Reasource.BlockNineByNineID;
	}
