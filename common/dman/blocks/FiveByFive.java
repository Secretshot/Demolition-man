...
public class FiveByFive extends Block{
	...
	public FiveByFive(int ID, Material Material) {
		...
		this.setUnlocalizedName(dman.library.Reasource.BlockFiveByFiveULName);
	}
	
	@SideOnly(Side.CLIENT)
	public void registerIcons(IconRegister icon){
		this.blockIcon = icon.registerIcon(Reasource.Mod_ID + ":" + dman.library.Reasource.ChargeTopBottom);
		this.iconFront = icon.registerIcon(Reasource.Mod_ID + ":" + dman.library.Reasource.BlockFiveByFiveTextName);
	...
	public int idDropped(int par1, Random random, int par3){
		return dman.library.Reasource.BlockFiveByFiveID;
	}
