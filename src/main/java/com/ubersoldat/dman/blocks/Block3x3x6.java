...
/**
 * Created by gregory.dere on 1/27/2016.
 */
public class Block3x3x6 extends BlockShapeCharge {
    ...
    public void registerBlockIcons(IIconRegister icon){
        ...
        this.iconFront = icon.registerIcon(Resource.Mod_ID + ":" + Resource.Block3x3x3Name);
	...
	*/
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitx, float hity, float hitz){
        ShapeObject.DemolishDeep(world,x,y,z, BlockOffset, ClearCenterOffset,DepthOffset);
