...
public class ModBlocks
{
    ...
    public static final BlockDman Threex3x15 = new Block3x3x15();
    public static final BlockDman Fivex5x5 = new Block5x5x5();
    public static final BlockDman Fivex5x10 = new Block5x5x10();
    public static final BlockDman Fivex5x15 = new Block5x5x15();
    ...
    public static void init()
    {
        ...
        GameRegistry.registerBlock(Threex3x15, Resource.Block3x3x15Name);
        GameRegistry.registerBlock(Fivex5x5, Resource.Block5x5x5Name);
        GameRegistry.registerBlock(Fivex5x10, Resource.Block5x5x10Name);
        GameRegistry.registerBlock(Fivex5x15, Resource.Block5x5x15Name);
